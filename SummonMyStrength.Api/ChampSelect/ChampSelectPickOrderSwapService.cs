...
internal class ChampSelectPickOrderSwapService : IChampSelectPickOrderSwapService
{
    ...
    {
        await _clientApiConnector.PostAsync($"lol-champ-select/v1/session/pick-order-swaps/{id}/accept", null);
    }
    ...
    {
        await _clientApiConnector.PostAsync($"lol-champ-select/v1/session/pick-order-swaps/{id}/decline", null);
    }
}
